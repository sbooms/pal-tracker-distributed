...
import io.pivotal.pal.tracker.eurekaserver.accounts.RegistrationController;
import io.pivotal.pal.tracker.eurekaserver.accounts.RegistrationForm;
import io.pivotal.pal.tracker.eurekaserver.accounts.RegistrationService;
import io.pivotal.pal.tracker.eurekaserver.users.UserInfo;
